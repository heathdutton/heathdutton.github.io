...
const defaults = {
	...
	cursorColor: hsl(0.625, 1, 0.85), // The color of the cursor (design-system brand cornflower, lifted for cursor punch)
	...
	palette: [
		...
		// Brand cornflower (#6C8CFF) — hue ~0.625, design-system T-60 anchor
		{ color: hsl(0.625, 1.0, 0.0), at: 0.0 },
		{ color: hsl(0.625, 1.0, 0.2), at: 0.2 },
		{ color: hsl(0.625, 1.0, 0.7), at: 0.7 },
		{ color: hsl(0.625, 1.0, 0.8), at: 0.8 },
	],
